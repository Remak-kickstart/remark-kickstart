...
<xsl:template name="pagination">
	...
	<xsl:param name="label-next" select="'Следующая'" />
	<xsl:param name="label-previous" select="'Предыдущая'" />
	<xsl:param name="class-pagination" select="'pager'" />
	...
	<xsl:param name="class-disabled" select="'hidden'" />
