...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	function getDynamicConfiguration(){
		...
		$conf['general']['sitename'] = 'ПКБ АСУ НЕФТЬ';
		$conf['image']['cache'] = '1';
		...
		$conf['content-type-mappings']['css'] = 'text/css; charset=utf-8';
		$conf['content-type-mappings']['json'] = 'application/json; charset=utf-8';
		$conf['globalresourceloader']['ds-names'] = 'page,page_blocks';
		$conf['globalresourceloader']['event-names'] = 'login,send_request';
		$conf['yandex_map_location']['api_key'] = 'AI-Yek8BAAAAMWxcNQMAUu3YAu5GwW0Zp7BTWw95FrNPY-wAAAAAAAAAAAC9MSYndqqr8dVBcFFaR8Ju0fSW5Q==';
		$conf['datetime']['russian'] = 'ru, ru_RU.UTF8, ru_RU';
